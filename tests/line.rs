...
fn test_line_intersection() {
    ...
    assert_eq!((r1, l1).intersection_point(), Some(Point2::new(0.5, 0.0)));
    ...
    assert_eq!((r2, l2).intersection_point(), Some(Point2::new(0.0, 0.0)));
    ...
    assert_eq!((r3, l3).intersection_point(), Some(Point2::new(0.0, 0.5)));
    ...
    assert_eq!((r6, l6).intersection_point(), Some(Point2::new(5.0, 5.0)));
    ...
    assert_eq!((r7, l7).intersection_point(), None);
    ...
    assert_eq!((r8, l8).intersection_point(), Some(Point2::new(3.0, 0.0)));
    ...
    assert_eq!((r9, l9).intersection_point(), None);
}
